...
function CustomerPortal() {
  ...
  const askEnu = async (customQuestion = "") => {
    ...
    if (!finalQuestion) {
      setResult({
        ...
        confidence: 0,
        question: "N/A",
        suggestion: "Please type a valid question above.",
      });
      return;
    }
    ...
    try {
      ...
      setResult({
        ...
        suggestion: "Verify that uvicorn main:app --reload is active in your backend terminal.",
      });
    } finally {
      setLoading(false);
    }
  ...
  const submitTicket = async () => {
    if (!ticketData.customer_name || !ticketData.issue) {
  ...
  return (
    <div className="portal">
      <aside className="sidebar">
        ...
        <nav className="menu">
          <button type="button" className="active" onClick={() => openChat()}>
            <FaRobot />
          ...
          <button
            type="button"
            onClick={() => openChat("My internet is not working")}
          >
            <FaWifi />
            <span>Internet</span>
          </button>
          <button
            type="button"
            onClick={() => openChat("My SIM card is not detected")}
          >
            <FaSimCard />
          ...
          <button
            type="button"
            onClick={() => openChat("How do I check my bill?")}
          >
            <FaCreditCard />
            <span>Billing</span>
          </button>
          <button
            type="button"
            onClick={() => openChat("I want to buy a data package")}
          >
            <FaGift />
            <span>Packages</span>
          </button>
          <button
            type="button"
            onClick={() => openChat("I need customer support")}
          >
            <FaHeadset />
            <span>Support</span>
          </button>
        ...
        <div className="help-card">
          ...
          <button
            type="button"
            onClick={() => openChat("How can I speak with a support agent?")}
          >
            <FaHeadset />
            Chat with Agent
          </button>
        ...
        <div className="app-card">
          ...
          <p>Manage your account, buy packages, pay bills and much more.</p>
      ...
      <main className="main">
          ...
          <div className="hero-grid">
            <div className="hero-copy">
              ...
              <p className="description">
                Smart telecom support for customers, service desk agents and engineers.
                Ask about internet, billing, SIM services, packages, troubleshooting and more.
        ...
        {result && (
          <section className="answer-card">
            ...
            <div className="answer-details">
              ...
              <p>
                <strong>Source:</strong> {result.source || "Telecom Knowledge Base"}
              </p>
              <p>
                <strong>Matched Question:</strong>{" "}
                {result.matched_question || result.question || "N/A"}
              </p>
              <p>
                <strong>Status:</strong>{" "}
                {result.found ? "Knowledge Found ✅" : "No Match ❌"}
              </p>
              {result.suggestion && (
                <p>
            ...
            <div className="ticket-modal">
              <div className="ticket-header">
                <div>
                  ...
                  <p>
                    Our support team will review your issue and contact you as soon as possible.
                  </p>
                </div>
                <div className="enu-avatar">🤖</div>
              </div>
              ...
              <div className="attach-ai">
                ...
                <span>Attach AI conversation to this ticket</span>
              </div>
        ...
        <footer className="footer">
          <p>
            Powered by <strong>Enu AI</strong> | Ethio Telecom Knowledge Assistant
          </p>
          <p>
            <span>FastAPI</span>
            <span>React</span>
